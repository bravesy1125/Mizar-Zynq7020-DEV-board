...
HD_PWD='D:/ZYNQ_Mizar-7020/06_Linux_Demo/6_petalinux_hdmi/petalinux_hdmi/petalinux_hdmi.runs/hdmi_out_rgb2dvi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_out_rgb2dvi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_out_rgb2dvi_0_1.tcl
